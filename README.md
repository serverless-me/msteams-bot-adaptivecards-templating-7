# Adaptive Cards Templating & SDK sample
...
The sample is based on [Using Adaptive Cards](https://github.com/microsoft/BotBuilder-Samples/tree/main/samples/javascript_nodejs/07.using-adaptive-cards).

It is extended by [Templating SDK](https://docs.microsoft.com/en-us/adaptive-cards/templating/sdk) and [Rendering cards inside your application](https://docs.microsoft.com/en-us/adaptive-cards/rendering-cards/getting-started).

Use [adaptivecards.io](https://adaptivecards.io/samples/) to try more samples:
- ./resources/CardData.json
- ./resources/CardTemplate.json
